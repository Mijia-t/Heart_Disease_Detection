...
# Generate and save model and scaler
def generate_and_save_model():
    '''
    Generate the Random Forest model and scaler and save them as files.
    ...
    if not os.path.exists(data_file):
        raise FileNotFoundError(f"Dataset file {data_file} is missing.")
